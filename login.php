...
<head>
    ...
    <title>Login - Password Storage App</title>
...
<body class="bg-gradient bg-info">
    <div class="container my-5">
        ...
        <div class="col-lg-5 col-md-7 col-sm-12 mx-auto my-auto">
            ...
            <?php endif; ?>
            <div class="card rounded-5 shadow my-4">
                ...
                <div class="card-footer py-2">
                    <div class="d-flex justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <button class="btn btn-primary btn-sm rounded-5 w-100" form="login-form"><i class="fa fa-save"></i> Login</button>
                        </div>
                    </div>
                </div>
            </div>
