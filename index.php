...
<body class="">
    ...
    <div class="container my-5">
        <div class="col-lg-12 col-md-12 col-sm-12 mx-auto">
            <?php if(isset($_SESSION['success_msg'])): ?>
                <div class="alert alert-success rounded-5 mb-2">
            ...
            <div class="card rounded-5 shadow">
                <div class="card-header rounded-5">
                    <div class="d-flex">
                        ...
                        <div class="col-auto">
                            <button class="btn btn-sm btn-primary rounded-5" id="add_pass"><i class="fa fa-plus"></i> Add Password</button>
                        </div>
                    </div>
                </div>
                <div class="card-body rounded-5">
                    ...
                    <div class="container-fluid">
                        <table class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th class="text-center bg-primary border-dark">Name</th>
                                    <th class="text-center bg-primary border-dark">Userame</th>
                                    <th class="text-center bg-primary border-dark">Password</th>
                                    <th class="text-center bg-primary border-dark">Description</th>
                                    <th class="text-center bg-primary border-dark">Site</th>
                                    <th class="text-center bg-primary border-dark">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <?php while($row = $data->fetch_assoc()): ?>
                                    <tr>
                                        <td class="p-1 bg-secondary border-dark">
                                            <div class="lh-1">
                                                <div><?= $row['name'] ?></div>
                                            </div>
                                        </td>
                                        <td class="p-1 bg-secondary border-dark"><?= $row['username'] ?></td>
                                        <td class="p-1 bg-secondary border-dark fw-bold encrypted_pass" data-value="<?= $row['password'] ?>"><?= str_repeat("*", strlen($row['password'])) ?></td>
                                        <td class="p-1 bg-secondary border-dark"><?= $row['description'] ?></td>
                                        <td class="p-1 bg-secondary border-dark "><?= $row['site']?></td>
                                        <td class="text-center bg-secondary border-dark">
                                            <div class="dropdown">
                                                <button class="btn btn-sm btn-dark border border-dark dropdown-toggle rounded-5" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    Action
                                                </button>
    ...
    <div class="modal fade" id="formModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog rounded-5 modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content rounded-5">
            <div class="modal-header rounded-5">
                ...
                <div class="container-fluid">
                    <form action="" id="password-form" method="POST">
                        ...
                        <div class="mb-3 ">
                            ...
                            <input type="text" class="form-control rounded-5" id="name" name="name" value="" required="required">
                        </div>
                        <div class="mb-3">
                            <label for="username" class="control-label">Username</label>
                            <input type="text" class="form-control rounded-5" id="username" name="username" value="" required="required">
                        </div>
                        <div class="mb-3">
                            <label for="password" class="control-label">Password</label>
                            <div class="input-group rounded-5">
                                <input type="password" class="form-control rounded-5" id="password" name="password" value="" required="required">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" cols="30" rows="3" class="form-control rounded-5"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="site" class="control-label">Site</label>
                            <input type="text" class="form-control rounded-5" id="site" name="site" value="" required="required">
                        </div>
                    </form>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-sm btn-primary rounded-5" form="password-form">Save</button>
